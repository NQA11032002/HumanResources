...
<section class="container">
    <div class="search">
        ...
        <form action="" method="GET" class="post-search d-flex">
            <div class="mb-3 container-input--form w-100">
                ...
                <input type="text" class="form-control keyword-search input-form" id="quickly-name" placeholder=" ">
                    ...
                    <ul class="posts-sidebar__item">
                        ...
                        <li>
                            <label for="career_{{ $career->id }}">
                                <input id="career_{{ $career->id }}" type="checkbox" name="" value="{{ $career->id }}">
                                {{ $career->name }}</label>
                        </li>
                        @endforeach
                    </ul>
                    ...
                    <div class="nav-item__content d-flex justify-content-between position-relative">
                        <div class="nav-item__content--left">
                            ...
                            <p class="salary"><i class="fa-solid fa-dollar-sign"></i> Lương: <span
                                    ...
                                    number_format($post->salary_from, 0, ',', '.') }}đ -
                                    {{ number_format($post->salary_to, 0, ',', '.') }}đ</span> </p>
                            <p class="address"><i class="fa-solid fa-location-dot"></i> {{ $post->address_work }}
                            </p>
